        ...
        <div class="container">
            <form action="/action_page.php">
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="text" id="fname" name="firstname" placeholder="Masukkan NIK sesuai KK">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <input type="text" id="lname" name="lastname" placeholder="Masukkan nama lengkap sesuai KK">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-75">
                <input type="text" id="lname" name="lastname" placeholder="+62">
                </div>
            </div>
